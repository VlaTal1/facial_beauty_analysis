...
with open('SCUT-FBP5500_v2/train_test_files/split_of_60%training and 40%testing/train.txt',
    ...
    write_to_csv(mark5, "csv/mark5_normalized")
    write_to_csv(mark4, "csv/mark4_normalized")
    write_to_csv(mark3, "csv/mark3_normalized")
    write_to_csv(mark2, "csv/mark2_normalized")
    write_to_csv(mark1, "csv/mark1_normalized")
